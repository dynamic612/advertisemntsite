...
export default function Home() {
    ...
    const [bestBudgetMattress, setBestBudgetMattress] = useState<object[]>([
        {
            ...
            description: 'Best Overall Hybrid Mattress',
        },
        {
            company: 'Helix Midnight Luxe',
            description: 'Best Hybrid Mattress for Side Sleepers',
        },
        {
            company: 'WinkBed',
            description: 'Best Hybrid Mattress for Back Pain',
        },
        {
            company: 'Nectar Hybrid',
            description: 'Best Value Hybrid',
        },
        {
            company: 'Bear Elite Hybrid',
            description: 'Best Soft Hybrid for Back Pain',
        },
    ]);
    ...
    const [compareData, setCompareData] = useState<any[]>([
            ...
            overview: [
                {
                    ...
                    title: "Material",
                    content: "Hybrid, combining a plush pillow top with coils and foams for a luxury feel."
                },
                {
                    img:"/img/best/firmness.svg",
                    title: "Firmness",
                    content: "Multiple firmness options: Softer, Luxury Firm, and Firmer. We tested the Luxury Firm and scored it a 7 out of 10, meaning it’s on the firmer side of medium-firm."
                },
                {
                ...
                },
                {
                    img:"/img/size.png",
                    title: "Size",
                    content: "Twin, twin XL, full, queen, king, California king",
                },
            ],
        ...
        },
        {
            ...
            sleep_position: "Combination",
            title: "WinkBed",
            sort: "Best Hyrbrid Mattress for Back Pain",
            content: "The WinkBed is a hybrid mattress that comes in three firmness levels, so most sleepers should find a model that suits their needs. It could also be a good fit for couples, thanks to reinforced edge support.",
            review: "/reviews",
            site: "https://www.winkbeds.com/pages/shop-winkbed?irclickid=XoWVr%3AxB9xyKU7b2Vu1IZxCeUkHV1fXHWQt71Y0&sharedid=&irpid=1196680&irgwc=1",
            productState: false,
            overviewState: true,
            overview: [
                {
        ...
        <div>
            <div className="flex min-h-screen flex-col items-center justify-start w-full">
                ...
                text-left text-wrap w-[80%] mb-20`}>
                    Hybrid mattresses aim to create a balanced feel by combining the benefits of foam, coils, and other materials. If you’re a sleeper wanting more than just one type of material, then this type of bed may hit the sweet spot. We’ll give our recommendations for the <span className="font-bold">best hybrid mattresses</span> , and down below we’ll explain the definition of a hybrid mattress. We’ll also review the benefit and touch on the different kinds of mattresses that you’ll find.
                </div>
                <div className="block text-center w-full mb-[20px] pl-[10%] lg:flex">
                    <div className="w-full lg:w-[65%]">
                        <div className="flex flex-col w-[90%] items-start justify-center bg-[#d2e1eb] rounded-[30px] py-[20px] px-[5%] mb-20">
                            <p className={`${styles.manropeFont} text-center md:text-left text-3xl font-bold w-full pb-[20px]`}>&nbsp; Best Hybrid Mattresses: &nbsp;</p>
                                            ...
                                            item.overviewState && <div className="block md:flex md:flex-wrap justify-center items-start text-center ml-[7%] gap-[5%] px-[10px] py-[5%] bg-white rounded-[10px] w-[90%]">
                                                {
                                                    item.overview.map((it:any, idx:any) =>
                                                        <div key={idx} className="flex flex-row justify-start items-center w-[100%] md:w-[45%] my-[5%]">
                                                            <Image
